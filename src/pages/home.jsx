                    ...
                    <div className="container-fluid modal-content bg-dark">
                      ...
                      <div className="modal-body">
                        <section className='imgProfil'>
                          <img src={profil.avatar_url} alt='Avatar de John Doe' className='img-fluid'/>
                        </section>
                        <section className='infosProfil'>
                          <p>
                            ...
                            <a href="https://github.com/github-john-doe" target='_blank' rel='noreferrer'>{profil.name}</a>
                          </p>
                          <p>
