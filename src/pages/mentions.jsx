...
export default function Mentions() {
    return (
        <div>
            <section className="container title-mentions">
                ...
                <div className="accordion-item">
                    ...
                    <div id="collapseThree" className="accordion-collapse collapse" data-bs-parent="#accordionExample">
                        <div className="accordion-body">
                            ...
                            <p><i>Les images utilisées sur ce site sont libres de droits et ont été obtenues sur le site <a href='https://pixabay.com/fr/'>Pixabay</a></i></p>
                            <p><i>La favicon de ce site a été fournie par <a href='https://www.flaticon.com/fr/chercher?word=John%20doe'>John doe Icons erstellt von Freepik - Flaticon</a></i></p>
                        </div>
                    </div>
                </div>
                </div>
